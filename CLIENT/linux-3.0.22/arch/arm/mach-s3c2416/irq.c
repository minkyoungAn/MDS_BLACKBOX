...
static inline void s3c2416_irq_ack_2(struct irq_data *data)
{
...
static void s3c2416_irq_mask_2(struct irq_data *data)
{
        unsigned long bitval = 1UL << (data->irq - IRQ_S3C2416_2D);
        unsigned long mask;
...
static void s3c2416_irq_unmask_2(struct irq_data *data)
{
        unsigned long bitval = 1UL << (data->irq - IRQ_S3C2416_2D);
        unsigned long mask;
...
struct irq_chip s3c_irq_chip_2 = {
	.name           = "s3c-2",
        .irq_ack        = s3c2416_irq_ack_2,
        .irq_mask       = s3c2416_irq_mask_2,
        .irq_unmask     = s3c2416_irq_unmask_2,
};
